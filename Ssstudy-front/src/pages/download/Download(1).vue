...
.allFile-container {
  ...
  height: 75vh; /* 调整高度，这里是相对视窗高度的百分比 */
  width: 80%; /* 调整宽度，这里是相对父容器宽度的百分比 */
  /* margin: 0 auto; 居中 */
  padding: 10px; /* 添加内边距，使内容距离容器边缘有一些间距 */
  border: 2px solid #333; /* 添加边框，可以根据需要调整颜色和粗细 */
